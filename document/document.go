...
*/
package document ;import (_ag "archive/zip";_cc "bytes";_d "errors";_b "fmt";_cg "github.com/zoeyfyi/unioffice";_aa "github.com/zoeyfyi/unioffice/color";_bd "github.com/zoeyfyi/unioffice/common";_cb "github.com/zoeyfyi/unioffice/common/tempstorage";_cce "github.com/zoeyfyi/unioffice/internal/license";_bg "github.com/zoeyfyi/unioffice/measurement";_df "github.com/zoeyfyi/unioffice/schema/schemas.microsoft.com/office/activeX";_dg "github.com/zoeyfyi/unioffice/schema/soo/dml";_ba "github.com/zoeyfyi/unioffice/schema/soo/dml/picture";_be "github.com/zoeyfyi/unioffice/schema/soo/ofc/sharedTypes";_gc "github.com/zoeyfyi/unioffice/schema/soo/pkg/relationships";_dc "github.com/zoeyfyi/unioffice/schema/soo/wml";_cf "github.com/zoeyfyi/unioffice/zippkg";_ab "image";_gg "image/jpeg";_ga "io";_f "log";_g "math/rand";_ce "os";_gd "path/filepath";_fd "strings";_a "unicode";);func (_bgec Paragraph )addFldCharsForField (_agfa ,_face string )FormField {_egdc :=_bgec .addBeginFldChar (_agfa );_edff :=FormField {_cede :_egdc };_adaec :=_bgec ._bfdb .Bookmarks ();_aaacf :=int64 (len (_adaec ));if _agfa !=""{_bgec .addStartBookmark (_aaacf ,_agfa );};_bgec .addInstrText (_face );_bgec .addSeparateFldChar ();if _face =="\u0046\u004f\u0052\u004d\u0054\u0045\u0058\u0054"{_cecc :=_bgec .AddRun ();_accce :=_dc .NewEG_RunInnerContent ();_cecc ._ggab .EG_RunInnerContent =[]*_dc .EG_RunInnerContent {_accce };_edff ._dgad =_accce ;};_bgec .addEndFldChar ();if _agfa !=""{_bgec .addEndBookmark (_aaacf );};return _edff ;};
